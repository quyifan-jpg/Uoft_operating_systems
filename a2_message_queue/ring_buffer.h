...
typedef struct ring_buffer {
	...
	size_t size;
	/** Index of the byte that marks the head of the buffer ("read" end). */
	size_t head;
	/** Index of the byte that marks the tail of the buffer ("write" end). */
	size_t tail;
...
/**
 * Retrieve and remove data from the head of a ring buffer.
 *
 * @param rb      pointer to the ring buffer.
...
/**
 * Retrieve data from the head of a ring buffer without removing it.
 *
 * @param rb      pointer to the ring buffer.
 * @param buffer  pointer to the buffer to copy data into.
...
/**
 * Insert data into the tail of a ring buffer.
 *
 * @param rb      pointer to the ring buffer.
